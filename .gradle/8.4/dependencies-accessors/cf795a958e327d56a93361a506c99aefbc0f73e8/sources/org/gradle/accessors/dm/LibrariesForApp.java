 ...
 */
@NonNullApi
public class LibrariesForApp extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForApp(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
