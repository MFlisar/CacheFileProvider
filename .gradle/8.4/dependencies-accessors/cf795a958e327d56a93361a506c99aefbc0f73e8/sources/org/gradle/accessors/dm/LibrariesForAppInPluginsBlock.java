...
/**
 * A catalog of dependencies accessible via the `app` extension.
 */
@NonNullApi
public class LibrariesForAppInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForAppInPluginsBlock(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
